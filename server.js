...
app.post('/submit', (req, res) => {
  ...
  const newEntry = {
    ...
    ai_fields: arr(b['ai_fields'] || b['ai_fields[]']),
    future_ai_fields: arr(b['future_ai_fields'] || b['future_ai_fields[]']),
    ...
    edu_methods: arr(b['edu_methods'] || b['edu_methods[]']),
    non_major_factor: b.non_major_factor || '',
    non_major_factor_other: b.non_major_factor_other || '',
    industry_fields: arr(b['industry_fields'] || b['industry_fields[]']),
    employment_competitiveness: b.employment_competitiveness || '',
    career_fields: arr(b['career_fields'] || b['career_fields[]']),
